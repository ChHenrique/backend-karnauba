...
export function Footer(){
    ...
    return(
        <div className="w-screen bg-neutrals-200 h-30 mt-30 flex pb-2  flex-col justify-end items-center">
            <div className=' flex justify-center gap-6   items-center h-fit  w-1/6 mb-3'>
